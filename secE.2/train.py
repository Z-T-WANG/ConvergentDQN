...
def train(env, args):
    ...
    if args.prioritized_replay:
        replay_buffer = PrioritizedReplayBuffer(args.buffer_size, args.alpha, args.IS_weight_only_smaller)
    else:
                    ...
                    if not args.silent:
                        ...
                        if args.save_best and step_idx > args.learning_start:
                            ...
                            if best_performance < mean_performance and len(recent_performances)>=40:
                                ...
                                torch.save((recent_models[0], step_idx), '{}/{}_{}.pth'.format(args.env, currentTask, args.comment))
